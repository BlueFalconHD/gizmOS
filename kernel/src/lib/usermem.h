 ...
 *
 * Returns RESULT_OK on success or RESULT_ERROR if any portion of the
 * destination range is not mapped user memory.
 */
RESULT_TYPE(void)
...
/*
 * Copy in a string from user space into a kalloc'd buffer.
 */
RESULT_TYPE(char *)
