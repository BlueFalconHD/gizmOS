...
//   // Align the kernel physical range to page boundaries for easier
//   comparison. kernel_phys_start &= ~(PAGE_SIZE - 1); // Floor to page
//   boundary kernel_phys_end = (kernel_phys_end + PAGE_SIZE - 1) &
